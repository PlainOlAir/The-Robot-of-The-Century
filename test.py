...
def teleop_main():
    ...
    Robot.set_value(left_motor, "duty_cycle", (-0.5 * Gamepad.get_value("joystick_left_y"))) 
    Robot.set_value(right_motor, "duty_cycle", (0.5 * Gamepad.get_value("joystick_right_y")))
